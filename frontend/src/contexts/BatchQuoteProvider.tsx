...
export const BatchQuoteProvider = ({ children }: { children: ReactNode }) => {
    ...
    const batchTotals = batchItems.reduce(
        (acc, item) => ({
            ...
            totalLaborConsumablesCost: acc.totalLaborConsumablesCost + (item.laborConsumablesCost || 0) * (item.quantity || 1),
            totalLaborMachineCost: acc.totalLaborMachineCost + (item.laborMachineCost || 0) * (item.quantity || 1),
        ...
        }),
        {
            ...
            totalLaborCost: 0,
            totalLaborConsumablesCost: 0,
            totalLaborMachineCost: 0,
            totalOverheadCost: 0,
            totalMarkup: 0,
            grandTotal: 0,
        }
