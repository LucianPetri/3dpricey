...
**Tests**: The examples below include test tasks. Automated tests are OPTIONAL unless
explicitly requested in the feature specification, but every feature MUST include
explicit validation tasks for affected lint, build, and manual workflows.
...
- [ ] T004 Map required documentation updates in .github/ and operational docs
...
- [ ] T011 Document offline-storage, sync, or migration prerequisites if data authority changes
...
- [ ] T020 [US1] Update required .github documentation for User Story 1 changes
...
- [ ] T027 [US2] Update required .github documentation for User Story 2 changes
...
- [ ] T033 [US3] Update required .github documentation for User Story 3 changes
...
- [ ] TXXX Run package-specific lint, build, and test commands and record results
- [ ] TXXX Execute manual validation for affected user workflows and deployment paths
